      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="rounded-[40px] overflow-hidden shadow-xl h-[520px]">
              <img
                src="/images/home.png"
            ...
            <div className="absolute bottom-6 right-6 bg-white rounded-3xl p-5 shadow-xl">
              <p className="text-[#035346] font-bold">A Place To Call Home</p>
